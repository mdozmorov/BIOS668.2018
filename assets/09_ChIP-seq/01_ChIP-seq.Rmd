...
## Building models for predicting transcription tactor binding sites
...
\begin{center}
\includegraphics[height=80px]{img/pwm1.png}
\end{center}
...
where $f_{b,i}$ - count of base$b$ in position $i$; $N$ - number of sites; $p(b,i)$ - corrected probability of base $b$ in position $i$; $s(b)$ - pseudocount function
...
\begin{center}
\includegraphics[height=80px]{img/pwm2.png}
\end{center}
...
where $p(b)$ - background probability of base $b$; $p(b,i)$ - corrected probability of base $b$ in position $i$; $W_{b,i}$ - PWM vaue of base $b$ in position $i$
...
\begin{center}
\includegraphics[height=80px]{img/pwm3.png}
\end{center}
...
\begin{center}
\includegraphics[height=80px]{img/pwm4.png}
\end{center}
...
\tiny Wasserman, Wyeth W., and Albin Sandelin. “Applied Bioinformatics for the Identification of Regulatory Elements.” Nature Reviews. Genetics 5, no. 4 (April 2004): 276–87. https://doi.org/10.1038/nrg1315.
