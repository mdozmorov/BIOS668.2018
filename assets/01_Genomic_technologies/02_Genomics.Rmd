...
\includegraphics[height=210px]{img/omics.jpg}
...
\includegraphics[height=150px]{img/chromosomes.png}

\tiny http://uswest.ensembl.org/Homo_sapiens/Location/Genome

## The human genome from a micro to macro scale 

\includegraphics[height=220px]{img/genome_scale1.png}

##  The basic structure of a chromosome

\begin{center}
\includegraphics[height=120px]{img/chromosome_structure.png}
\end{center}
...
\begin{center}
\includegraphics[height=90px]{img/chromosome_division.png}
\end{center}
...
\includegraphics[height=60px]{img/giemsa.png}
...
\begin{center}
\includegraphics[height=120px]{img/retrotransposons.png}
\end{center}
...
\includegraphics[height=200px]{img/sanger_sequencing1.jpg}
...
\includegraphics[height=150px]{img/shotgun.png}
...
\includegraphics[height=140px]{img/library.png}
...
\includegraphics[height=90px]{img/nasasdnasequ.jpg}

\includegraphics[height=90px]{img/zika.png}
...
\includegraphics[height=210px]{img/pacbio_vs_oxnano.png}
...
\includegraphics[height=200px]{img/seq_pachter.png}
...
\includegraphics[height=200px]{img/developments_in_high_throughput_sequencing.jpg}
