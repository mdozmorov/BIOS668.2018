...
- Open-reference clustering involves performing closed-reference clustering followed by de novo clustering on those sequences that are not su ciently similar to the reference.
